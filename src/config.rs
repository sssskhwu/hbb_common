...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "<SKHskh2025>".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["103.219.39.102"];
pub const RS_PUB_KEY: &str = "lWMHlYgn1c6M+A9FI5NQKKNTg5PtSDQMGh6Wimbyn8c=";
